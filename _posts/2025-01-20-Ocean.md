...
The energy spectrum texture only has to be computed once unless you change the parameters, but if we want our waves to move we have to update the spectrum by multiplying it with Euler's formula. <img src="/img/hlt.png" alt="Image" width="400"/>
