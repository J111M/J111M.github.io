...
tags: [rendering, ocean, graphics]
image:
  path: /assets/img/posts/ocean/CalmOcean.gif
  alt: Ocean rendering video running on the PS5
math: true
---
...
<video width="420" height="360" controls>
  <source src="/assets/img/posts/ocean/horizonzerodawn.mp4" type="video/mp4">
</video>
[*Horizon forbidden west swimming through a rough ocean*](https://www.youtube.com/watch?v=XT-xhCNalPc)


<video width="420" height="360" controls>
  <source src="/assets/img/posts/ocean/seaofthieves.mp4" type="video/mp4">
</video>
...
<img src="/assets/img/posts/ocean/Fig16-9s.jpg" alt="Image" width="400"/>
...
Is the Wave energy spectrum of choice

(ξr​+ξi​) 

are the Gaussian distributed real and imaginary random numbers
...
<img src="/assets/img/posts/ocean/initialSpectrum.png" alt="Image" width="400"/>
...
<img src="/assets/img/posts/ocean/eulersformula.png" alt="Image" width="400"/>
...
For this algorithm we need to sort the data so that the even and odd numbers are grouped together we do this by doing a binary reversal on the index of the pixel so px1, px2, ..., after reversing the binaries we simply count up the binary numbers and we are left with the first half being even numbers and the second half being odd.
 ...
 <img src="/assets/img/posts/ocean/shapes at 25-01-22 12.57.07.png" alt="Image" width="400"/>
...
<img src="/assets/img/posts/ocean/butterflyAlgorithm.png" alt="Image" width="400"/>
...
<img src="/assets/img/posts/ocean/slopemapfft.png" alt="Image" width="400"/>
...
<img src="/assets/img/posts/ocean/displacementMap.png" alt="Image" width="400"/>
<br> *Final displacement map*
<br>
 <img src="/assets/img/posts/ocean/slopemap.png" alt="Image" width="400"/>
 <br> *Final slope map*
...
<img src="/assets/img/posts/ocean/atlasrendereing.png" alt="Image" width="400"/>
...
In short they talk about approximating light scattering through the wave since it would be to expensive to calculate it accurately. The fake scattering by using the formula bellow 
 ...
 <img src="/assets/img/posts/ocean/Shading.png" alt="Image" width="400"/>
...
<img src="/assets/img/posts/ocean/jacobianfoam.png" alt="Image" width="400"/>

## Final result
<video width="420" height="360" controls>
  <source src="/assets/img/posts/ocean/CalmOcean.mp4" type="video/mp4">
</video>

<video width="420" height="360" controls>
  <source src="/assets/img/posts/ocean/roughocean.mp4" type="video/mp4">
</video>
<video width="420" height="360" controls>
  <source src="/assets/img/posts/ocean/Watershowcase.mp4" type="video/mp4">
</video>
## Optimizations
...
<video width="420" height="360" controls>
  <source src="/assets/img/posts/ocean/FrustumCulling.mp4" type="video/mp4">
</video>

*I reduced the frustum size to display a working version*
...
<img src="/assets/img/posts/ocean/Logo BUas_RGB.png" alt="Image" width="350"/>